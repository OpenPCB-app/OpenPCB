...
This skill covers the schematic capture editor — how symbols, wires, net labels, and connectivity work. For rendering specifics (Three.js patterns), see the `r3f-eda-rendering` skill. For component data model, see `library` skill.
