/**
 * PadInstances — Renders PCB pads as InstancedMesh.
 *
 * Groups pads by shape type for minimal draw calls.
 * Supports per-instance color and selection highlighting.
 */
...
export function PadInstances({
  ...
  // Use a simple box geometry — shapes are approximated via scale
  // For a v1, we use circle for circle/oval, rect for rect/roundrect
  ...
  // Separate circle-like and rect-like pads
