/**
 * PinDots — Renders pin connector dots as InstancedMesh.
 *
 * Single draw call for all pins regardless of count.
 * Supports per-instance color (connected vs unconnected).
 */
...
interface PinDotsProps {
  ...
  /** Radius of pin dots in nanometers */
  radius?: number;
  defaultColor?: string;
