import { createHttpServer, DiagnosticsStore, ModuleRouterRegistry, ModuleRuntime } from "./runtime";
...
console.log(`[core-backend] listening on http://${bunServer.hostname}:${bunServer.port}`);
