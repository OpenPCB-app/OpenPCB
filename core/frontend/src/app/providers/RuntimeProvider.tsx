...
import { listenForElectronBackendReady, resolveBackendURL } from "../runtime/resolve-backend-url";
  ...
  useEffect(() => {
    ...
    const bootstrap = async () => {
      try {
        ...
        if (mounted) {
          setError(err instanceof Error ? err.message : "Failed to resolve backend URL");
        }
      }
    };
