...
import { GUIDE_OPACITY } from "./guide-types";
 ...
 * every zoom; dashing distinguishes them from real geometry. Geometry sits at
 * z=0 with depthTest/Write disabled; `renderOrder` controls layering.
 */
