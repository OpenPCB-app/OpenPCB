...
import type { FootprintPreviewModel } from "../../../rendering";
...
function FootprintGeometryLayer({ model }: { model: FootprintPreviewModel }) {
...
export function FootprintPreviewCanvas({
  ...
  return (
    ...
    >
      {model ? <FootprintGeometryLayer model={model} /> : null}
    </PreviewCanvasShell>
  );
}
