...
export const EMIT_SITE_BY_CODE: Record<DrcRuleCode, { checks: readonly string[] }> = {
  // clearance / shorts
  TRACE_TO_TRACE_CLEARANCE: { checks: ["clearance"] },
  TRACE_TO_PAD_CLEARANCE: { checks: ["clearance"] },
  TRACE_TO_VIA_CLEARANCE: { checks: ["clearance"] },
  VIA_TO_VIA_CLEARANCE: { checks: ["clearance"] },
  PAD_TO_PAD_CLEARANCE: { checks: ["clearance"] },
  PAD_TO_VIA_CLEARANCE: { checks: ["clearance"] },
  // Shorts fall out of the same geometric pass as the clearance verdicts.
  NET_SHORT_CIRCUIT: { checks: ["clearance"] },
  FAB_CLEARANCE: { checks: ["clearance"] },
