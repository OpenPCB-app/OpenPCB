...
- Non-destructive edits apply at once and are undoable in OpenPCB. Deletions wait for the user to approve in OpenPCB's assistant panel: tell the user; do not re-send them.
