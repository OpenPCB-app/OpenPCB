...
import {
  ...
  ResizablePanel,
  ResizablePanelGroup,
} from "openpcb-app/src/components/ui/resizable";
...
import { useDesigns } from "openpcb-app/src/hooks/useDesigns";
import { DesignHeader } from "openpcb-app/src/screens/design/DesignHeader";
import { EditorToolbar } from "openpcb-app/src/components/pcb/toolbar/EditorToolbar";
import { SchematicCanvasR3F as SchematicCanvas } from "openpcb-app/src/lib/render-engine/adapters/SchematicCanvasR3F";
import { ComponentPalette } from "openpcb-app/src/components/pcb/palette/ComponentPalette";
import { StatusBar } from "openpcb-app/src/components/pcb/StatusBar";
import { useSchematicInteractionController } from "openpcb-app/src/components/pcb/useSchematicInteractionController";
import { PcbCanvasR3F as PcbCanvas } from "openpcb-app/src/lib/render-engine/adapters/PcbCanvasR3F";
import { PcbSidebar } from "openpcb-app/src/components/pcb-editor/PcbSidebar";
import { PcbToolbar } from "openpcb-app/src/components/pcb-editor/PcbToolbar";
import { useSchematicStore } from "openpcb-app/src/stores/schematic-store";
import { usePcbStore } from "openpcb-app/src/stores/pcb-store";
import {
  createEmptySchematicDocument,
  createUnsavedSchematicDraft,
  hasSchematicCanvasContent,
} from "openpcb-app/src/components/pcb/schematic-document";
import { extractNets } from "openpcb-app/src/components/pcb/canvas/net-extraction";
import { getSheetContent, saveSheetContent } from "openpcb-app/src/lib/api/design-api";
import {
  toEditorPcbDocument,
  toEditorSchematicDocument,
  toProjectDocumentBundle,
} from "openpcb-app/src/components/pcb/types";
import { useToast } from "openpcb-app/src/components/ui/use-toast";
import { createEmptyPcbDocument } from "openpcb-app/src/components/pcb-editor/pcb-types";
